...
export default (props) => (
    <div className='App'>
        ...
        <Card titulo='#02 - Componente com paramentro Array(10) de elementos com propriedade repetição .fil(2)' color='#E94C6F'>
        ...
        <Card titulo='#04 - Componente com Função Repetição' color='#E94C6F'>
            <Repeticao></Repeticao>
        </Card>
